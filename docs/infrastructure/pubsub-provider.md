...
The defaults are chosen so Pubsub Provider can run next to [Bitsocial Seeder](https://bitsocial.net/apps/bitsocial-seeder/) on the same VPS without a swarm-port conflict.
