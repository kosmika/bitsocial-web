...
export default function SettlementLayer() {
  return (
    <Section
      ...
      supporting="Bitsocial Chain is the proposed Ethereum L2 for Bitsocial. Communities run their own L3s, tokens and DAOs, yet they settle, stake and pay rent in BSO, so value across the whole economy accrues to a single token."
      ...
      <div className="stack-tree">
        ...
        <div className="tree-tier tree-l2">
          ...
          <span className="tree-l2-text">
            ...
            <span className="tree-l2-meta">Ethereum L2 · BSO settlement</span>
          </span>
        </div>
