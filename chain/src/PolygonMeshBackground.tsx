...
const STATIC_POLYGON_MESH_FALLBACK_SOURCES: Record<Theme, string> = {
...
function NoScriptStaticPolygonMeshBackground() {
  return (
    <noscript>
      <StaticPolygonMeshBackground theme="dark" />
    </noscript>
  );
}
...
const PolygonMeshBackground = memo(function PolygonMeshBackground() {
  ...
  }, [isGraphicsModePending, meshSeed, shouldAnimate, shouldUseStaticFallback, theme]);
  ...
  if (shouldUseStaticFallback) {
    return <StaticPolygonMeshBackground theme={theme} />;
  }
